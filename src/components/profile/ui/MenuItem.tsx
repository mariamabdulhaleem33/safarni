    ...
    return (
        ...
        >
            <div className="flex items-center gap-4">
                <Icon
                    size={22}
                    className={`stroke-[1.5] ${isDestructive
                        ? 'text-red-500'
                        : isActive
                            ? 'text-blue-600'
                            : 'text-gray-600'
                ...
                />
                <span className={`font-medium text-base ${isDestructive
                    ? 'text-red-500'
                    : isActive
                        ? 'text-blue-700'
                        : 'text-gray-800'
            ...
            {!isDestructive && (
                <ChevronRight
                    size={20}
                    className={`transition-colors ${isActive ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-600'}`}
                />
            )}
        </div>
    );
