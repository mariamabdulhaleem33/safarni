    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-start pt-10 px-4">
            ...
            <div className="w-full max-w-3xl space-y-6">
                ...
                <div className="relative w-full border border-rose-300 rounded-3xl p-6 flex items-center gap-6 bg-white">
                ...
                <div className="w-full border border-rose-300 rounded-3xl p-6 space-y-4 bg-white">
